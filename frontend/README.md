...
- `npm run test:run`: run once (CI/local checks)
...
- Reusable render with providers: `src/test/test-utils.tsx`
...
Coverage is configured in `vite.config.ts` with thresholds:
